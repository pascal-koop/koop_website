	...
	<section
		...
		<div
			...
			<div class="work-tech-stack flex flex-col">
				<h2 class="work-card-subtitle font-neueRegrade text-xl font-bold text-textDark mt-8 mb-2 mx-8 uppercase"
					>{{ project.title }}&nbsp;
				</h2>
				...
				<p class="work-card-text font-rota text-lg text-textDark mx-8 my-6">{{ project.description }}</p>
				<NuxtLink
